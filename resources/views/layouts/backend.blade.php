...
<html lang="{{ config('app.locale') }}" class="no-focus">
    <head>
        ...
        <title>Cloud - SMS</title>

        <meta name="description" content="Cloud - SMS">
        <meta name="author" content="prasong">
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a class="link-effect font-w700" href="/">
                                    ...
                                    <span class="font-size-xl text-dual-primary-dark">Cloud</span><span class="font-size-xl text-primary">SMS</span>
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            <li>
                                <a class="{{ request()->is('/') ? ' active' : '' }}" href="{{ route('send-sms') }}">
                                    <i class="fa fa-send"></i><span class="sidebar-mini-hide">{{ ucfirst(__('sms.menu.send')) }}</span>
                                </a>
                            </li>
                            <li>
                                <a class="{{ request()->is('history') ? ' active' : '' }}" href="{{ route('history-sms') }}">
                                    <i class="fa fa-history"></i><span class="sidebar-mini-hide">{{ ucfirst(__('sms.menu.history')) }}</span>
                                </a>
                            </li>
                            <li>
                                <a class="{{ request()->is('config') ? ' active' : '' }}" href="{{ route('config-sms') }}">
                                    <i class="fa fa-gears"></i><span class="sidebar-mini-hide">{{ ucfirst(__('sms.menu.config')) }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Crafted with by <a class="font-w600" href="#" target="_blank">MIS</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="#" target="_blank">CLOUD-SMS</a> &copy; <span class="js-year-copy">2021</span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
